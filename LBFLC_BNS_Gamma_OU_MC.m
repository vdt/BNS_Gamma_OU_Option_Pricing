...
% function LBFLC_BNS_Gamma_OU_MC uses Monte Carlo simulation to
% estimate the price of a Floating Strike Lookback Call option under the BNS model
...
function LBFLC_BNS_Gamma_OU_MC(lambda,a,b,tho,S0,r,q,sigma,T,N,n)
