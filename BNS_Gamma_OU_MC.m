...
% function BNS_Gamma_OU_MC uses Monte Carlo simulation to
% estimate the price of a European call option under the BNS model
...
function BNS_Gamma_OU_MC(lambda,a,b,rho,K,S0,r,q,T,N,n)
