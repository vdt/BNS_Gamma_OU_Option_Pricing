...
% function UIBC_BNS_Gamma_OU_MC uses Monte Carlo simulation to
% estimate the price of a Up-and-in Barrier Call option under the BNS model
...
function UIBC_BNS_Gamma_OU_MC(lambda,a,b,rho,S0,K,H,r,q,sigma,T,N,n)
