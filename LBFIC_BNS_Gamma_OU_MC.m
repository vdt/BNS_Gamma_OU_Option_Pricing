...
% function LBFIC_BNS_Gamma_OU_MC uses Monte Carlo simulation to
% estimate the price of a Fixed Strike Lookback Call option under the BNS model
...
function LBFIC_BNS_Gamma_OU_MC(lambda,a,b,rho,S0,K,r,q,sigma,T,N,n)
